...
public abstract class VerticalBaseTransformer implements ViewPager.PageTransformer {
   ...
   * pager. 0 is front and center. 1 is one full page position to the right, and -1 is one page
   ...
   * be overridden. Instead use {@link #transformPage(View, float)} to perform typical
   * transformations.
   *
   * @param page Apply the transformation to this page
   * @param position Position of page relative to the current front-and-center position of the
   ...
   * transforms that do not modify the same page properties. For instance changing from a
