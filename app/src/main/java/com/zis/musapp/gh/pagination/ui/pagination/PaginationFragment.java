 ...
 * the License.
 */
package com.zis.musapp.gh.pagination.ui.pagination;
...
import com.zis.musapp.gh.pagination.data.EmulateResponseManager;
...
public class PaginationFragment extends Fragment {
  ...
  private void init(View view, Bundle savedInstanceState) {
    ...
    PaginationTool<List<Item>> paginationTool =
        ...
        .subscribe(new Subscriber<List<Item>>() {
          ...
          public void onNext(List<Item> items) {
            ...
            recyclerViewAdapter.notifyItemInserted(
                recyclerViewAdapter.getItemCount() - items.size());
          }
        });
  }
