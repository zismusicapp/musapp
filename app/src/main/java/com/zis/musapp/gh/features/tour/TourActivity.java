  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    viewPager.setOnScrollListener(new ScrollListener() {
      ...
      public void onScroll(int y, float page) {
        ...
        if (page < 1) {
          ...
          if (page >= 1 && page <= lastPageIndex) {
            ...
            if (!mainContentHidden) {
              ...
              background.animate()
                  .y(-loginHolder.getTop() + Screen.dp(8))
                  .alpha(1)
                  .setDuration(0)
                  .start();
        ...
        float paralaxY = -(((float) paralaxImageHeight - paralaxHolderHeight) * ((float) page
            / (lastPageIndex)));
    ...
    if (Build.VERSION.SDK_INT >= 19) {
      ...
      contentTopPadding = Screen.getInstance().getStatusBarHeight();
      RelativeLayout.LayoutParams params =
          (RelativeLayout.LayoutParams) findViewById(R.id.pager_container).getLayoutParams();
